    ...
    match input.data {
        ...
        Data::Enum(enum_) => {
            ...
            Ok(quote! {
                ...
                impl #impl_generics crate::protocol::Encode for #input_name #ty_generics
                #where_clause
                {
                    fn encode(&self, mut _w: impl ::std::io::Write) -> crate::protocol::Result<()> {
                        use crate::protocol::{Encode, VarInt, Context};
